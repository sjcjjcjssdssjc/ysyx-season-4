...
VL_ATTR_COLD void Vysyx_22040127_top___024root__trace_init_sub__TOP__0(Vysyx_22040127_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+70,"instruction", false,-1, 31,0);
    tracep->declBus(c+71,"pc", false,-1, 31,0);
    tracep->declQuad(c+72,"r_wdata", false,-1, 63,0);
    tracep->declBit(c+65,"r_wen", false,-1);
    tracep->declBus(c+74,"rd", false,-1, 4,0);
    tracep->declBus(c+75,"rs1", false,-1, 4,0);
    tracep->declBus(c+76,"rs2", false,-1, 4,0);
    tracep->declBus(c+66,"inst_type", false,-1, 2,0);
    tracep->declQuad(c+77,"imm", false,-1, 63,0);
    tracep->declBit(c+87,"imm_src0", false,-1);
    tracep->declBit(c+67,"imm_src1", false,-1);
    tracep->declBit(c+79,"ebreak", false,-1);
    tracep->declQuad(c+80,"src0", false,-1, 63,0);
    tracep->declQuad(c+82,"src1", false,-1, 63,0);
    tracep->declQuad(c+80,"reg_data0", false,-1, 63,0);
    tracep->declQuad(c+84,"reg_data1", false,-1, 63,0);
    ...
    tracep->declBus(c+66,"inst_type", false,-1, 2,0);
    tracep->declQuad(c+77,"imm", false,-1, 63,0);
    tracep->declBus(c+88,"TYPE_I", false,-1, 2,0);
    tracep->declBus(c+89,"TYPE_U", false,-1, 2,0);
    tracep->declBus(c+90,"TYPE_S", false,-1, 2,0);
    tracep->declBus(c+91,"TYPE_J", false,-1, 2,0);
    tracep->declBus(c+92,"TYPE_R", false,-1, 2,0);
    tracep->declBus(c+93,"TYPE_B", false,-1, 2,0);
    tracep->declBus(c+94,"TYPE_N", false,-1, 2,0);
    ...
    tracep->declQuad(c+77,"imm", false,-1, 63,0);
    tracep->declBus(c+66,"inst_type", false,-1, 2,0);
    tracep->declQuad(c+72,"alu_output", false,-1, 63,0);
    tracep->declBus(c+95,"TYPE_I", false,-1, 31,0);
    tracep->declBus(c+96,"TYPE_U", false,-1, 31,0);
    tracep->declBus(c+97,"TYPE_S", false,-1, 31,0);
    tracep->declBus(c+98,"TYPE_J", false,-1, 31,0);
    tracep->declBus(c+99,"TYPE_R", false,-1, 31,0);
    tracep->declBus(c+100,"TYPE_B", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declQuad(c+72,"wdata", false,-1, 63,0);
    tracep->declBus(c+74,"waddr", false,-1, 4,0);
    tracep->declBus(c+75,"raddr1", false,-1, 4,0);
    tracep->declBus(c+76,"raddr2", false,-1, 4,0);
    tracep->declQuad(c+80,"rdata1", false,-1, 63,0);
    tracep->declQuad(c+84,"rdata2", false,-1, 63,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declQuad(c+1+i*2,"rf", true,(i+0), 63,0);
    }
    tracep->declBit(c+86,"non_zerow", false,-1);
...
VL_ATTR_COLD void Vysyx_22040127_top___024root__trace_full_sub_0(Vysyx_22040127_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+65,((1U & (~ (IData)((0U != (IData)(vlSelf->ysyx_22040127_top__DOT__inst_type)))))));
    tracep->fullCData(oldp+66,(vlSelf->ysyx_22040127_top__DOT__inst_type),3);
    tracep->fullBit(oldp+67,((0U == (IData)(vlSelf->ysyx_22040127_top__DOT__inst_type))));
    tracep->fullBit(oldp+68,(vlSelf->clk));
    tracep->fullBit(oldp+69,(vlSelf->rst));
    tracep->fullIData(oldp+70,(vlSelf->instruction),32);
    tracep->fullIData(oldp+71,(vlSelf->pc),32);
    tracep->fullQData(oldp+72,(((0U == (IData)(vlSelf->ysyx_22040127_top__DOT__inst_type))
                                 ? (vlSelf->ysyx_22040127_top__DOT__regs__DOT__rf
                                    [(0x1fU & (vlSelf->instruction 
                                               >> 0xfU))] 
                                    + ((0U == (IData)(vlSelf->ysyx_22040127_top__DOT__inst_type))
                                        ? (((- (QData)((IData)(
                                                               (vlSelf->instruction 
                                                                >> 0x1fU)))) 
                                            << 0xcU) 
                                       ...
                                       [(0x1fU & (vlSelf->instruction 
                                                  >> 0x14U))]))
                                 : 0ULL)),64);
    tracep->fullCData(oldp+74,((0x1fU & (vlSelf->instruction 
                                         >> 7U))),5);
    tracep->fullCData(oldp+75,((0x1fU & (vlSelf->instruction 
                                         >> 0xfU))),5);
    tracep->fullCData(oldp+76,((0x1fU & (vlSelf->instruction 
                                         >> 0x14U))),5);
    tracep->fullQData(oldp+77,((((- (QData)((IData)(
                                 ...
                                 << 0xcU) | (QData)((IData)(
                                                            (vlSelf->instruction 
                                                             >> 0x14U))))),64);
    tracep->fullBit(oldp+79,((((6U == (IData)(vlSelf->ysyx_22040127_top__DOT__inst_type)) 
                               & (vlSelf->instruction 
                                  >> 0x14U)) & (~ (IData)(
                                                          (0U 
                                                           != 
                                                           (0xffefff80U 
                                                            & vlSelf->instruction)))))));
    tracep->fullQData(oldp+80,(vlSelf->ysyx_22040127_top__DOT__regs__DOT__rf
                               [(0x1fU & (vlSelf->instruction 
                                          >> 0xfU))]),64);
    tracep->fullQData(oldp+82,(((0U == (IData)(vlSelf->ysyx_22040127_top__DOT__inst_type))
                                 ? (((- (QData)((IData)(
                                                        (vlSelf->instruction 
                                                         >> 0x1fU)))) 
                                     << 0xcU) | (QData)((IData)(
                                ...
                                [(0x1fU & (vlSelf->instruction 
                                           >> 0x14U))])),64);
    tracep->fullQData(oldp+84,(vlSelf->ysyx_22040127_top__DOT__regs__DOT__rf
                               [(0x1fU & (vlSelf->instruction 
                                          >> 0x14U))]),64);
    tracep->fullBit(oldp+86,((0U != (0x1fU & (vlSelf->instruction 
                                              >> 7U)))));
    tracep->fullBit(oldp+87,(0U));
    tracep->fullCData(oldp+88,(0U),3);
    tracep->fullCData(oldp+89,(1U),3);
    tracep->fullCData(oldp+90,(2U),3);
    tracep->fullCData(oldp+91,(3U),3);
    tracep->fullCData(oldp+92,(4U),3);
    tracep->fullCData(oldp+93,(5U),3);
    tracep->fullCData(oldp+94,(6U),3);
    tracep->fullIData(oldp+95,(0U),32);
    tracep->fullIData(oldp+96,(1U),32);
    tracep->fullIData(oldp+97,(2U),32);
    tracep->fullIData(oldp+98,(3U),32);
    tracep->fullIData(oldp+99,(4U),32);
