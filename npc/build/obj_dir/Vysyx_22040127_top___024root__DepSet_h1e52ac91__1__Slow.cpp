...
VL_ATTR_COLD void Vysyx_22040127_top___024root___ctor_var_reset(Vysyx_22040127_top___024root* vlSelf) {
    ...
    VL_ZERO_RESET_W(128, vlSelf->ysyx_22040127_top__DOT__icache__DOT__axi_req_data);
    vlSelf->ysyx_22040127_top__DOT__icache__DOT__mem_wen = 0;
    vlSelf->ysyx_22040127_top__DOT__icache__DOT__mem_strb = 0;
    vlSelf->ysyx_22040127_top__DOT__icache__DOT__axi_res_valid = 0;
    vlSelf->ysyx_22040127_top__DOT__icache__DOT__axi_req_strb = 0;
    vlSelf->ysyx_22040127_top__DOT__icache__DOT__axi_req_valid = 0;
    vlSelf->ysyx_22040127_top__DOT__icache__DOT__axi_req_addr = 0;
    VL_ZERO_RESET_W(128, vlSelf->ysyx_22040127_top__DOT__icache__DOT__axi_mrdata);
    ...
    VL_ZERO_RESET_W(128, vlSelf->ysyx_22040127_top__DOT__dcache__DOT__axi_req_data);
    vlSelf->ysyx_22040127_top__DOT__dcache__DOT__mem_wen = 0;
    vlSelf->ysyx_22040127_top__DOT__dcache__DOT__mem_strb = 0;
    vlSelf->ysyx_22040127_top__DOT__dcache__DOT__axi_res_valid = 0;
    vlSelf->ysyx_22040127_top__DOT__dcache__DOT__axi_req_wen = 0;
    vlSelf->ysyx_22040127_top__DOT__dcache__DOT__axi_req_strb = 0;
    vlSelf->ysyx_22040127_top__DOT__dcache__DOT__axi_req_valid = 0;
    vlSelf->ysyx_22040127_top__DOT__dcache__DOT__axi_req_addr = 0;
    VL_ZERO_RESET_W(128, vlSelf->ysyx_22040127_top__DOT__dcache__DOT__axi_mrdata);
    for (int __Vi0=0; __Vi0<128; ++__Vi0) {
    ...
    vlSelf->__Vtask_ysyx_22040127_top__DOT__icache__DOT__pmem_read__2__doubly_aligned_data = 0;
    vlSelf->__Vtask_ysyx_22040127_top__DOT__icache__DOT__pmem_read__3__doubly_aligned_data = 0;
    vlSelf->__Vtask_ysyx_22040127_top__DOT__dcache__DOT__pmem_read__4__doubly_aligned_data = 0;
    vlSelf->__Vtask_ysyx_22040127_top__DOT__dcache__DOT__pmem_read__5__doubly_aligned_data = 0;
    for (int __Vi0=0; __Vi0<2; ++__Vi0) {
