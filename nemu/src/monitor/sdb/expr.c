...
unsigned eval(int p, int q,bool *fail) {
  if (p > q) {
    *fail = 1;
    ...
    printf("%u\n",(unsigned int)(62)*(11+(22/(11))-((84)-94*((((82/39))/38*49/64*22))/16)));
    //printf("%u\n", ((((unsigned int)(62)*(11+(22/(11))-((84)-94*((((82/39))/38*49/64*22))/16)))-(58)/(67)+(63)-54/(((31)/5))))*(23)-((29))-32*44/(((((((79))+(68)/((88))*31*((36)))/31-((4))))))*((94))-(((41)))+((80))*(48)*79*(79));
    int op = -1,sum = 0;
    int nowlev = 2;
    for(int i = p; i <= q; i++){
      if(tokens[i].str[0] == '(')sum++;
