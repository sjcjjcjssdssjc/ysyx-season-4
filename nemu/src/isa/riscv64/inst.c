...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(dest) = SEXT((src1 & 0xFFFFFFFF) / (src2 & 0xFFFFFFFF), 32));
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, R(dest) = SEXT((src1 & 0xFFFFFFFF) % (src2 & 0xFFFFFFFF), 32));
